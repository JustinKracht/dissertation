...
Results for conditions with Fair or Poor target model fit were less straightforward. When target model fit was Fair, the $\textrm{TKL}_{\textrm{CFI}}$ method generally led to the highest (or near highest) rates of qualitative agreement of the model-error methods, particular when factor loadings were weak and when there were many major common factors. When target model fit was Poor, the $\textrm{TKL}_{\textrm{CFI}}$ still led to the highest qualitative fit agreement rates 
