...
```{r c129-heat-maps, out.width = "100%"}
...
Although the lack-of-fit between $\bm{\Sigma}$ and $\bm{\Omega}$ was of primary interest in this dissertation, the lack-of-fit between $\bm{\Sigma}$ and $\hat{\bm{\Omega}}$ may also be of interest to some researchers. Figures reporting the distributions of RMSEA, CFI, TLI, and CRMR values representing the lack-of-fit between $\bm{\Sigma}$ and $\hat{\bm{\Omega}}$ (analogous to \@ref(fig:rmsea-distributions), \@ref(fig:cfi-distributions), \@ref(fig:tli-distributions), and \@ref(fig:crmr-distributions)) are provided in \@ref(sigma-hat-fit-indices). In addition to looking at the distributions of fit indices, I was also interested in how $\textrm{RMSEA}_{\hat{\theta}}$ was related to RMSEA and how $\textrm{CFI}_{\hat{\theta}}$ was related to CFI.
...
```{r, include = FALSE}
# FIGURE TO MODIFY: Effect of factors and items-per-factor on RMSEA theta/thetahat
results_matrix %>%  
  slice_sample(prop = .1) %>% 
