...
if (fit_mods) {
  ...
  mmf_coef_tab <- texreg::texreg(
    ...
    use.packages = FALSE,
    caption.above = FALSE,
    caption = 'Coefficient estimates and standard errors for the logistic regression model predicting the probability of producing a solution with violated $W$ constraints (i.e., at least one minor factor with more than two absolute factor loadings greater than 0.3).',
...
### $|\textrm{RMSEA}_{\textrm{obs}} - \textrm{RMSEA}_{\textrm{T}}|$ Analysis of Variance
...
d1_apa$table$Effect <- fix_apa_coef_names(d1_apa$table$Effect)
...
### $|\textrm{CFI}_{\textrm{obs}} - \textrm{CFI}_{\textrm{T}}|$ Analysis of Variance
...
d2_apa$table$Effect <- fix_apa_coef_names(d2_apa$table$Effect)
...
d3_apa$table$Effect <- fix_apa_coef_names(d3_apa$table$Effect)
...
### Logistic Regression on Qualitative Model Fit Index Agreement
...
### $\textrm{RMSEA}_{\Delta}$ Analysis of Variance
...
rmsea_delta_apa$table$Effect <- fix_apa_coef_names(rmsea_delta_apa$table$Effect)
...
### $\textrm{CFI}_{\Delta}$ Analysis of Variance
...
cfi_delta_apa$table$Effect <- fix_apa_coef_names(cfi_delta_apa$table$Effect)
