...
+ Changing the value of $\lambda$ did not lead to much better results.
+ However, the $\TKLrmseacfi$ and $\TKLcfi$ methods seldom produced solutions with violated constraints.
...
## Indefinite $\bSigma$ Matrices

xxx

# Conclusions & Future Work

+ The $\TKLcfi$ and $\TKLrmseacfi$ methods 
