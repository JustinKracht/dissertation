...
- $\hat{\bm{\Omega}}_{p \times p}$: The model-implied population covariance (correlation) matrix obtained from analyzing $\mathbf{\Sigma}$ (the population correlation matrix with model error).
